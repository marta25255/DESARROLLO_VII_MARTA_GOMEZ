...
function productomayorvalor($inv) {
    ...
    // Recorrer el arreglo
    foreach ($inv as $producto => $info) {
        // Calcular el valor total del producto (cantidad * precio)
        $valorTotal = $info["cantidad"] * $info["precio"];
        
        // Si el valor total es mayor que el valor anterior guardado, actualizamos
    ...
    echo "El producto con el mayor valor total en inventario es: $productoMayor con un valor total de: $mayorValor.\n";
}
