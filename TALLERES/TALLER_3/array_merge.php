...
$misComidas = ["Pizza", "Sushi", "Tacos"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["Pasta", "Hamburguesa", "Ensalada"]; // Reemplaza con las comidas favoritas de tu amigo
